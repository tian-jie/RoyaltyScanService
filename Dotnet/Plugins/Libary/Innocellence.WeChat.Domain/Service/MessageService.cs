...
namespace Innocellence.WeChat.Domain.Services
{
    ...
    public partial class MessageService : BaseService<Message>, IMessageService
    {
        ...
        public MessageService(IPushService pushService)
            : base("CAAdmin")
        {
            _pushService = pushService;
        }
        ...
        public Result<object> CheckMessagePushRule(int appId, int accountMangageId, IList<int> selectedDepartmentIds, IList<int> selectedTagIds, IList<string> selectedWeChatUserIDs, int contentId, bool isToAllUsers)
        {
