...
using CheckResult = Innocellence.WeChat.Domain.Entity.CheckResult;
...
namespace Innocellence.WeChat.Domain.Services
{
    ...
    public partial class ArticleInfoService : BaseService<ArticleInfo>, IArticleInfoService
    {
        ...
        private readonly IPushService _pushService = EngineContext.Current.Resolve<IPushService>();
        ...
        public ArticleInfoService(IUnitOfWork unitOfWork,
            ...
            IArticleThumbsUpService articleThumbsUpService, IPushService pushService)
            : base("CAAdmin")
        {
        ...
        public Result<object> CheckMessagePushRule(int appId, int accountMangageId, IList<int> selectedDepartmentIds, IList<int> selectedTagIds, IList<string> selectedWeChatUserIDs, int contentId, bool isToAllUsers = false)
        {
            return _pushService.PushCheck(new TargetInfoObject
                         {
                             Departments = selectedDepartmentIds,
                             IsToAllUsers = isToAllUsers,
                             Tags = selectedTagIds,
                             Users = selectedWeChatUserIDs,
                             ContentId = contentId
                         }, appId, accountMangageId, ContentType.Message);
