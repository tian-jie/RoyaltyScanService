...
namespace Innocellence.Web.Controllers
{
    ...
    public class HomeController : BaseController<AccountManage, AccountManageView>
    {
        ...
        public HomeController(IAccountManageService objService, ISysMenuService menuService, ISysWechatConfigService wechatConfigService)
            : base(objService)
        {
        ...
        {
            return Redirect("/LccpBackendAdmin/home/Welcome");
            //var list = FilterAccountManageByUser();
            //ViewBag.Company = list.Where(a => a.AccountType == 0).ToList();
            //ViewBag.Service = list.Where(a => a.AccountType == 1).ToList();
            //ViewBag.link = CommonService.GetSysConfig("WeChatLink", string.Empty);
            //ViewBag.PlatformId = CommonService.GetSysConfig("PlatformId", string.Empty);
            //return View();
        }
