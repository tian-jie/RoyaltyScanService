...
namespace Innocellence.Web.Controllers
{
    public class MSSqlController : BaseController<Category, CategoryView>
    {
        ...
        public override ActionResult Index()
        {
            ...
            //var connStringsView = new List<SelectListItem>();

            //foreach (ConnectionStringSettings cs in connStrings)
            //{
            //    connStringsView.Add(new SelectListItem()
            //    {
            //        Text = cs.Name,
            ...
            //};
            //var selectList = new SelectList(connStrings, "ConnectionString", "Name");
            //selectItemList.AddRange(selectList);

            ViewBag.ConnectionStrings = connStrings;
